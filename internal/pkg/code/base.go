...
const (
	...
	// ErrValidationCustom - 400: Validation failed with custom message.
	ErrValidationCustom
)
...
const (
	...
	ErrRedis
	ErrDBQueryDataFailed
	ErrDBAddDataFailed
	ErrDBUpdateDataFailed
	ErrDBDeleteDataFailed
)
...
const (
	...
	// ErrDecodingStructToMap - 500:  data could not be decoded.
	ErrDecodingStructToMap

	// ErrDecodingMapToStruct - 500:  data could not be decoded.
	ErrDecodingMapToStruct

	// ErrGenerateToken - 500:  generate token failed
	ErrGenerateToken
)
